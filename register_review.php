...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users_review (username, password) VALUES (?, ?)";
        ...
        if($stmt = mysqli_prepare($koneksi, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: login_review.php?alert=benar");
            } else{
                echo "Oops! Silahkan refresh dan daftar kembali.";
            }
            ...
            <div class="col-xl-5 col-lg-6col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                                ...
                                <div class="p-5">
									...
									<p>Sudah memiliki akun? <a href="login_review.php">Login sekarang</a>.</p>
									</form>
                                    <hr>
